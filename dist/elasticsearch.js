...
(function(my) {
        ...
        this._normalizeQuery = function(queryObj) {
            ...
            if (queryInfo.q) {
                ...
                if(queryInfo.boostFields) {
                    ...
                    query.query_string.fields = _fields;
                    query.query_string.lenient = true;
    ...
    this._convertFilter = function(filter) {
        ...
        if (filter.type === 'term') {
            ...
            console.log("here we are mate... " + JSON.stringify(filter));
            ...
            if(!_.isUndefined(filter.from) && !isNaN(filter.from) && filter.from) {
                 console.log("elasticsearch: " + filter.from);
